...
<form class="form-horizontal form-validate-jquery" action="#" id="video_form" method="POST">
								<div class="panel panel-flat">
									...
									<div class="panel-body">
										...
										<div class="text-right">
											<button type="button" onclick="save_video()" class="btn btn-primary" id="pnotify-solid-styled-left">Submit form <i class="icon-arrow-right14 position-right"></i></button>
										</div>
									</div>
								</div>
