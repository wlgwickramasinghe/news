				...
				<div class="page-header page-header-default">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active">Add Advertisment</li>
						</ul>
...
<form class="form-horizontal form-validate-jquery" action="#" id="advertisment_form" method="POST">
								<div class="panel panel-flat">
									...
									<div class="panel-body">
										<fieldset>
											...
											<div class="collapse in" id="demo1">
												<div class="form-group">
													...
													<div class="col-lg-9">
														<input type="text" required name="advertisment" class="form-control" placeholder="Enter Advertisment name">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-lg-9">
														<input type="text" required name="width" class="form-control" placeholder="Enter Width">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-lg-9">
														<input type="text" required name="height" class="form-control" placeholder="Enter Height">
													</div>
												</div>
										...
										<div class="text-right">
											<button type="button" onclick="save_advertisment()" class="btn btn-primary" id="pnotify-solid-styled-left">Submit form <i class="icon-arrow-right14 position-right"></i></button>
										</div>
									</div>
								</div>
