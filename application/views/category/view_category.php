			...
			<div class="content-wrapper">
              ...
              <div class="panel panel-flat">
                 <div class="panel-heading">
                  <div class="col-lg-6"> 
                    <h5 class="text-semibold">Category List</h5> 
                  </div>
                ...
                <table class="table datatable-column-search-selects">
                  ...
                  <?php 	for($i=0; $i < count($category_list);++$i){?>
                    ...
                    <tr>
							  <td><?php echo $category_list[$i]['id']; ?></td>
                              <td><?php echo $category_list[$i]['category']; ?></td>
                              <td><?php if($category_list[$i]['status']=='A'){echo "<span class='label label-success'>Active</span>";}else{echo "<span class='label label-danger'>Inactive</span>";} ?></td>
                              <td hidden=""></td>
                              <td hidden=""></td>

                      <td class="text-center">
                        <?php if($this->session->userdata('UserGroup') == 'Admin' || $this->session->UserGroup == "Doctor"){ ?>
                        <a class="btn border-info text-info-600 btn-flat btn-icon btn-rounded" href="<?php echo base_url();?>index.php/category/edit_category/<?php echo $category_list[$i]['id'];?>?page=drug"><i class="icon-pencil7"></i></a>
                      <?php } ?>
