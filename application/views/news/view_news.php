			...
			<div class="content-wrapper">
              ...
              <div class="panel panel-flat">
                 <div class="panel-heading">
                  <div class="col-lg-6"> 
                    <h5 class="text-semibold">News List</h5> 
                  </div>
                ...
                <table class="table datatable-column-search-selects">
                  ...
                  <?php 	for($i=0; $i < count($news_list);++$i){?>
                    ...
                    <tr>
							  <td><?php echo $news_list[$i]['id']; ?></td>
                              <td><?php echo $news_list[$i]['title']; ?></td>
                              <td><?php echo $news_list[$i]['type']; ?></td>
                              <td><?php echo $news_list[$i]['content']; ?></td>
                              <td><?php echo $news_list[$i]['category']; ?></td>
                              <td><?php echo $news_list[$i]['country']; ?></td>
                              <td><?php if($news_list[$i]['status']=='A'){echo "<span class='label label-success'>Active</span>";}else{echo "<span class='label label-danger'>Inactive</span>";} ?></td>
                             

                      <td class="text-center">
                        <?php if($this->session->userdata('UserGroup') == 'Admin' || $this->session->UserGroup == "Doctor"){ ?>
                        <a class="btn border-info text-info-600 btn-flat btn-icon btn-rounded" href="<?php echo base_url();?>index.php/news/edit_news/<?php echo $news_list[$i]['id'];?>?page=drug"><i class="icon-pencil7"></i></a>
                      <?php } ?>
