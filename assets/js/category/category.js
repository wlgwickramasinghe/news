...
function save_category() {
  ...
  $.ajax({
    url: base_url+'index.php/category/save_category',
    type: 'POST',
    dataType: 'json',
    data: data
  })
  .done(function() {
    ...
    $('#category_form')[0].reset();
     setTimeout(function(){
  window.location = base_url+"index.php/category/view_category?page=category";
  },1000);
  })
  .fail(function(data) {
...
data = $('#category_form_edit').serializeArray();

$.ajax({
  url: base_url+'index.php/category/update_category',
  type: 'POST',
  dataType: 'json',
  data: data
})
