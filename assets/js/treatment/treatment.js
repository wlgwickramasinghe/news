function save_treatment() {
  ...
  data = $('#treatment_form').serializeArray();

  $.ajax({
    url: base_url+'index.php/treatment/save_treatment',
    type: 'POST',
    dataType: 'json',
    data: data
  })
  .done(function(data) {
    ...
    setTimeout(function(){
         var newWidget = $(data);
  window.location = base_url+"index.php/treatment/view_treatment?page=treatment";
},1000);
...
$.ajax({
  url: base_url+'index.php/treatment/update_treatment',
  type: 'POST',
  dataType: 'json',
  data: data
})
